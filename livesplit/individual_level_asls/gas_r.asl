state("FDNYFirefighter", "1.0")
{
     ...
     *   Values: Level names like "gas_r", "mission1", etc.
     *   Usage Examples:
     *     - Check specific level: current.mapName.ToLower().Contains("gas_r")
...
startup
{
    settings.Add("autostart", true, "Auto-start timer on gas_r level");
...
start
{
    // Start when: game state becomes 1 AND map is "gas_r"
