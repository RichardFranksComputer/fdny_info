...
FULL_RUN_OUTPUT_FILE                   # $LIVESPLIT_DIR/full_run.asl
FULL_RUN_NO_GROUPS_OUTPUT_FILE         # $LIVESPLIT_DIR/full_run_no_groups.asl
...
Jobs:
  ...
  3. Run ./livesplit/scripts/il_asl_generator.sh
  4. Verify files generated
  5. Commit and push with message "Auto-generate individual level ASL files [skip ci]"
...
Jobs:
  ...
  3. Run ./livesplit/scripts/full_run_asl_generator.sh
  4. Run ./livesplit/scripts/full_run_no_groups_asl_generator.sh
  5. Verify files generated
  6. Commit and push with message "Auto-generate full run ASL files [skip ci]"
