...
The Goal
Monitor when a specific sound plays in FDNY Firefighter (a Genesis3D game from ~2004) so LiveSplit can auto-split a speedrun.
Sounds simple, right? WRONG.

Step 1: The Initial Setup (Seemed Easy)

Set breakpoint on FMOD.FSOUND_PlaySoundEx in the FMOD.dll
Added condition: ECX == 0x0a902f00 (the sound buffer we wanted to track)
Breakpoint hit! Found 4 instruction addresses that access this value:
...
Memory access on 0x0a902f00
Instruction at 0x004a0d04
