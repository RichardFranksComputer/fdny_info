 ...
 * 
 * SETUP INSTRUCTIONS:
 * 1. Replace mbase with your target map name (e.g., "training")
...
startup
{
    print("[FDNY] Script loaded - Target map: mbase");
    vars.frameCount = 0;
    vars.hasSplit = false;
}
...
start
{
    ...
    bool mapCheck = current.mapName.ToLower().Trim().Contains("mbase");
