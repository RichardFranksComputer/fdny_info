 ...
 * 
 * SETUP INSTRUCTIONS:
 * 1. Replace subway_a with your target map name (e.g., "training")
...
startup
{
    print("[FDNY] Script loaded - Target map: subway_a");
    vars.frameCount = 0;
    vars.hasSplit = false;
}
...
start
{
    ...
    bool mapCheck = current.mapName.ToLower().Trim().Contains("subway_a");
