 ...
 * 
 * SETUP INSTRUCTIONS:
 * 1. Replace oil_rig_b with your target map name (e.g., "training")
...
startup
{
    print("[FDNY] Script loaded - Target map: oil_rig_b");
    vars.frameCount = 0;
    vars.hasSplit = false;
}
...
start
{
    ...
    bool mapCheck = current.mapName.ToLower().Trim().Contains("oil_rig_b");
