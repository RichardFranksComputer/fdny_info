 ...
 * 
 * SETUP INSTRUCTIONS:
 * 1. Replace boat_a with your target map name (e.g., "training")
...
startup
{
    print("[FDNY] Script loaded - Target map: boat_a");
    vars.frameCount = 0;
    vars.hasSplit = false;
}
...
start
{
    ...
    bool mapCheck = current.mapName.ToLower().Trim().Contains("boat_a");
