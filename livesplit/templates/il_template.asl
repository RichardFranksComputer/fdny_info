 ...
 * 
 * SETUP INSTRUCTIONS:
 * 1. Replace {{MAP_NAME_PLACEHOLDER}} with your target map name (e.g., "training")
...
startup
{
    print("[FDNY] Script loaded - Target map: {{MAP_NAME_PLACEHOLDER}}");
    vars.frameCount = 0;
    vars.hasSplit = false;
}
...
start
{
    ...
    bool mapCheck = current.mapName.ToLower().Trim().Contains("{{MAP_NAME_PLACEHOLDER}}");
