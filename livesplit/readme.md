...
- Look in genesis.dll to find how console messages are logged and see if it can be monitored --- this is geEngine_PrintF
- [TChatterSet] Playing shuffled sound: RC_ResLvlWin 0
