 ...
 * 
 * SETUP INSTRUCTIONS:
 * 1. Replace bar_r with your target map name (e.g., "training")
...
startup
{
    print("[FDNY] Script loaded - Target map: bar_r");
    vars.frameCount = 0;
    vars.hasSplit = false;
}
...
start
{
    ...
    bool mapCheck = current.mapName.ToLower().Trim().Contains("bar_r");
