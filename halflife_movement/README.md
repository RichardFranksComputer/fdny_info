...
Below is AI slop to PoC half life movement using [FreemanAPI](https://github.com/gaycoderprincess/FreemanAPI) by [gaycoderprincess](github.com/gaycoderprincess)

It needs a cleanup pass, but it does what was needed - proving functionality.
